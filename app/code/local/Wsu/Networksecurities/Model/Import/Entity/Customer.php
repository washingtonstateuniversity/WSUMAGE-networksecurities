<?php
class Wsu_Networksecurities_Model_Import_Entity_Customer extends Mage_ImportExport_Model_Import_Entity_Customer {
    /**
     * Gather and save information about customer entities.
     *
     *  make is_active for new customer importeable
     *  make is_active updateable for existing customers
     *
