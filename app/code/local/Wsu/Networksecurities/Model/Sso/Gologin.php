...
class Wsu_Networksecurities_Model_Sso_Gologin extends Google_Client {
	...
	public function __construct() {
		...
		$this->_config->setRedirectUri(Mage::getUrl('sociallogin/gologin/user',array('_secure'=>true)));		
	}		 
}
