 ...
 */
class Wsu_NewtworkSecurities_Block_Adminhtml_System_Config_ApiWizard extends Mage_Adminhtml_Block_System_Config_Form_Field {
    /**
    ...
    public function test_config() {
        ...
        $username  = trim(Mage::getStoreConfig('wsu_newtworksecurities/ldap/adminlogin/testusername'));
        $password  = trim(Mage::getStoreConfig('wsu_newtworksecurities/ldap/adminlogin/testuserpass'));
