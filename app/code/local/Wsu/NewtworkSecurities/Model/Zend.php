<?php
class Wsu_NewtworkSecurities_Model_Zend extends Zend_NewtworkSecurities_Image implements Wsu_NewtworkSecurities_Model_Interface {
    /**
     * Key in session for newtworksecurities code
     */
    const SESSION_WORD = 'word';
    /**
     * Min newtworksecurities lengths default value
     */
    const DEFAULT_WORD_LENGTH_FROM = 3;
    /**
     * Max newtworksecurities lengths default value
     */
    const DEFAULT_WORD_LENGTH_TO = 5;
    /**
     * Helper Instance
     * @var Wsu_NewtworkSecurities_Helper_Data
     */
    protected $_helper = null;
    /**
     * NewtworkSecurities expire time
     * @var int
     */
    protected $_expiration;
    /**
     * Override default value to prevent a newtworksecurities cut off
     * @var int
     * @see Zend_NewtworkSecurities_Image::$_fsize
     */
    protected $_fsize = 22;
    /**
     * NewtworkSecurities form id
     * @var string
     */
    protected $_formId;
    /**
     * Zend newtworksecurities constructor
     *
     * @param array $params
     */
    ...
    public function getBlockName() {
        return 'newtworksecurities/newtworksecurities_zend';
    }
    /**
     * Whether newtworksecurities is required to be inserted to this form
     *
    ...
    public function isRequired($login = null) {
        ...
        return ($this->_isShowAlways() || $this->_isOverLimitAttempts($login) || $this->getSession()->getData($this->_getFormIdKey('show_newtworksecurities')));
    }
    /**
    ...
    protected function _isOverLimitIpAttempt() {
        $countAttemptsByIp = Mage::getResourceModel('newtworksecurities/log')->countAttemptsByRemoteAddress();
    ...
    protected function _isOverLimitLoginAttempts($login) {
        if ($login != false) {
            $countAttemptsByLogin = Mage::getResourceModel('newtworksecurities/log')->countAttemptsByUserLogin($login);
    ...
    /**
     * Get font to use when generating newtworksecurities
     *
     * @return string
     */
    ...
    /**
     * Get newtworksecurities image directory
     *
     * @return string
     */
    ...
    /**
     * Get newtworksecurities image base URL
     *
     * @return string
     */
    ...
    /**
     * Checks whether newtworksecurities was guessed correctly by user
     *
     * @param string $word
     * @return bool
     */
    ...
    /**
     * Return full URL to newtworksecurities image
     *
     * @return string
     */
     ...
     *
     * @param string $login
     * @return Wsu_NewtworkSecurities_Model_Zend
     */
    public function logAttempt($login) {
        if ($this->_isEnabled() && in_array($this->_formId, $this->_getTargetForms())) {
            Mage::getResourceModel('newtworksecurities/log')->logAttempt($login);
            if ($this->_isOverLimitLoginAttempts($login)) {
                $this->getSession()->setData($this->_getFormIdKey('show_newtworksecurities'), 1);
            }
        }
        return $this;
    }
    /**
     * Returns path for the font file, chosen to generate newtworksecurities
     *
     * @return string
     */
    ...
    /**
     * Returns newtworksecurities helper
     *
     * @return Wsu_NewtworkSecurities_Helper_Data
     */
    protected function _getHelper() {
        if (empty($this->_helper)) {
            $this->_helper = Mage::helper('newtworksecurities');
        }
        return $this->_helper;
    }
    /**
     * Generate word used for newtworksecurities render
     *
     * @return string
     */
    ...
    /**
     * Returns length for generating newtworksecurities word. This value may be dynamic.
     *
     * @return int
     */
    ...
    /**
     * Whether to show newtworksecurities for this form every time
     *
     * @return bool
     */
    protected function _isShowAlways() {
        ...
        if ((string) $this->_getHelper()->getConfigNode('mode') == Wsu_NewtworkSecurities_Helper_Data::MODE_ALWAYS) {
            return true;
        }
    ...
    /**
     * Whether newtworksecurities is enabled at this area
     *
     * @return bool
     */
    ...
    /**
     * Retrieve list of forms where newtworksecurities must be shown
     *
    ...
    /**
     * Set newtworksecurities word
     *
     * @param  string $word
     * @return Zend_NewtworkSecurities_Word
     */
    protected function _setWord($word) {
        $this->getSession()->setData($this->_getFormIdKey(self::SESSION_WORD), array(
            'data' => $word,
    ...
    /**
     * Override function to generate less curly newtworksecurities that will not cut off
     *
     * @see Zend_NewtworkSecurities_Image::_randomSize()
     * @return int
     */
     ...
     *
     * Now deleting old newtworksecurities images make crontab script
     * @see Wsu_NewtworkSecurities_Model_Observer::deleteExpiredImages
     */
